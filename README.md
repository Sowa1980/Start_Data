...
## Основана на вики страницах [1](https://wiki.openstreetmap.org/wiki/RU:Key:start_date,) [2](https://wiki.openstreetmap.org/wiki/RU:Key:opening_date) и часто используемых тегов.
### Установка
